...
DEFAULT_WG_URL="https://raw.githubusercontent.com/MasterALiReza/WG_Panel/refs/heads/main/wg.py"
...
Examples:
  sudo $0
  sudo $0 --force-fetch
  sudo $0 https://raw.githubusercontent.com/MasterALiReza/WG_Panel/refs/heads/main/wg.py
  sudo $0 -- --no-color
EOF
}
