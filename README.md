...
<img src="https://raw.githubusercontent.com/MasterALiReza/WG_Panel/main/static/img/logo.png" width="120" alt="OxWg Panel Logo" />

# 🔐 OxWg Panel

**A modern, full-featured WireGuard management panel**

[![Version](https://img.shields.io/badge/version-1.1.0-blue?style=flat-square)](https://github.com/MasterALiReza/WG_Panel/releases)
...
[![License](https://img.shields.io/github/license/MasterALiReza/WG_Panel?style=flat-square)](LICENSE)
[![Stars](https://img.shields.io/github/stars/MasterALiReza/WG_Panel?style=flat-square)](https://github.com/MasterALiReza/WG_Panel/stargazers)
...
```bash
sudo bash -c 'command -v curl >/dev/null 2>&1 || (apt-get update -y && apt-get install -y curl ca-certificates); bash -c "$(curl -fsSL https://raw.githubusercontent.com/MasterALiReza/WG_Panel/main/wg.sh)"'
```
...
```bash
sudo bash -c 'command -v curl >/dev/null 2>&1 || (apt-get update -y && apt-get install -y curl ca-certificates); bash -c "$(curl -fsSL https://raw.githubusercontent.com/MasterALiReza/WG_Panel/main/agent/node.sh)"'
```
...
> Optionally overwrite peers that already have a custom endpoint.
...
<details>
<summary>🤖 Settings — Telegram Bot</summary>

![Settings Bot](https://github.com/user-attachments/assets/a87617da-18e0-4065-b2ed-d38d4322958b)
...
Made with ❤️ · [GitHub](https://github.com/MasterALiReza/WG_Panel) · [Report an Issue](https://github.com/MasterALiReza/WG_Panel/issues)
